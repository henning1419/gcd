classdef Table < matlab.mixin.SetGet
    ...
    methods
        ...
        function setSelectedRow(obj, row)
            ...
            %
            % Syntax:
            %           obj.setSelectedCell(row)
            %           setSelectedCell(obj,row)
            %
            % Inputs:
            %           obj - Table object
    ...
    methods
        ...
        function addRow(obj, row, idx)
            % Check
            assert(iscell(row) && ndims(row) == 2, ...
                'uiextras:Table:InvalidArgument', ...
                'Property ''Data'' must be a cell array.') %#ok<ISMAT>
            ...
            JTableModel.insertRow(idx-1,obj.castToJavaArray(row))
