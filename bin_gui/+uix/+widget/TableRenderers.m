    ...
    methods
        ...
        function defineFormats(obj)
            ...
            obj.Formats = {
                ...
                'float2'      com.mathworks.consulting.swing.table.NumberCellRenderer('###0.00') com.jidesoft.grid.DoubleCellEditor
    ...
    methods (Static = true)
        ...
        function obj = getRenderers()
            ...
            if isempty(sObj) || ~isvalid(sObj)
                sObj = uix.widget.TableRenderers;
            end
        ...
        function [StatusOk, Message] = validateColumnFormat(name)
            ...
            obj = uix.widget.TableRenderers.getRenderers();
